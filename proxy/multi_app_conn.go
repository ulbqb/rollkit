...
type multiAppConn struct {
	...
	consensusConnClient rollabcicli.Client
	mempoolConnClient   rollabcicli.Client
	queryConnClient     rollabcicli.Client
	snapshotConnClient  rollabcicli.Client
...
func (app *multiAppConn) abciClientFor(conn string) (rollabcicli.Client, error) {
