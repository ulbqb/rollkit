...
func (_m *Application) GenerateFraudProof(_a0 rolltypes.RequestGenerateFraudProof) rolltypes.ResponseGenerateFraudProof {
	ret := _m.Called(_a0)

	var r0 rolltypes.ResponseGenerateFraudProof
	if rf, ok := ret.Get(0).(func(rolltypes.RequestGenerateFraudProof) rolltypes.ResponseGenerateFraudProof); ok {
		r0 = rf(_a0)
	} else {
		r0 = ret.Get(0).(rolltypes.ResponseGenerateFraudProof)
	}
...
func (_m *Application) VerifyFraudProof(_a0 rolltypes.RequestVerifyFraudProof) rolltypes.ResponseVerifyFraudProof {
	ret := _m.Called(_a0)

	var r0 rolltypes.ResponseVerifyFraudProof
	if rf, ok := ret.Get(0).(func(rolltypes.RequestVerifyFraudProof) rolltypes.ResponseVerifyFraudProof); ok {
		r0 = rf(_a0)
	} else {
		r0 = ret.Get(0).(rolltypes.ResponseVerifyFraudProof)
	}
...
func (_m *Application) GetAppHash(_a0 rolltypes.RequestGetAppHash) rolltypes.ResponseGetAppHash {
	ret := _m.Called(_a0)

	var r0 rolltypes.ResponseGetAppHash
	if rf, ok := ret.Get(0).(func(rolltypes.RequestGetAppHash) rolltypes.ResponseGetAppHash); ok {
		r0 = rf(_a0)
	} else {
		r0 = ret.Get(0).(rolltypes.ResponseGetAppHash)
	}
